(async function() {
    ...
    var AllCommentsXPath = '/html/body/div[2]/div[2]/div[2]/div[1]/div[3]/div/div[4]/div[2]';
    ...
    var tiktokNumberOfCommentsXPath = '/html/body/div[2]/div[2]/div[2]/div[1]/div[3]/div/div[1]/div[3]/button[2]/strong';
    ...
    function csvFromComment(comment) {
        ...
        return quoteString(commentText) + ',' + commentLikesCount;
    }
    ...
    while (loadingCommentsBuffer > 0) {
        ...
        if(numOfcommentsAftScroll >= 15){
            loadingCommentsBuffer = 0;
        }
